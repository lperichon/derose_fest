Ext.define('DeRoseFest.util.Proxy', {
		...
		Ext.data.JsonP.request({
		    ...
		    success: function(data) {
		        ...
		        Ext.Array.each(data.proposals, function(proposal) {
		            ...
		            proposal.speakerIds = [];
		            proposalModel = Ext.create('DeRoseFest.model.Session', proposal);

		            Ext.Array.each(proposal.speakers, function(speaker) {
		                proposal.speakerIds.push(speaker.id);

		                speakerModel = Ext.create('DeRoseFest.model.Speaker', speaker);
		        ...
		        DeRoseFest.sessionDays = Ext.Array.sort(Ext.Object.getValues(sessionDays), function(a, b) {
